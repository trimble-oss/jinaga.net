...
using Jinaga.Store.PostgreSQL.Test.Fakes;
using Jinaga.Store.PostgreSQL.Test.Model;
using Microsoft.Extensions.Logging.Abstractions;
using Xunit.Abstractions;

namespace Jinaga.Store.PostgreSQL.Test.Observers;
public class WatchFromNetworkTest : IClassFixture<PostgresTestFixture>
{
    private readonly PostgresTestFixture fixture;
    private readonly ITestOutputHelper output;
    private readonly PostgreSQLStore store;

    public WatchFromNetworkTest(PostgresTestFixture fixture, ITestOutputHelper output)
    {
        this.fixture = fixture;
        this.output = output;
        this.store = fixture.CreateStore();
    }
    ...
    private JinagaClient GivenJinagaClient(FakeNetwork network)
    {
        var options = new JinagaClientOptions();
        return new JinagaClient(store, network, [], NullLoggerFactory.Instance, options);
    }
