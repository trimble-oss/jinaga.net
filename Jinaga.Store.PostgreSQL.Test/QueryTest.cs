...
public class QueryTest : IClassFixture<PostgresTestFixture>
{
    private readonly JinagaClient j;
    private readonly ITestOutputHelper output;

    public QueryTest(PostgresTestFixture fixture, ITestOutputHelper output)
    {
        var options = new JinagaClientOptions();
        j = new JinagaClient(fixture.CreateStore(), new LocalNetwork(), [], NullLoggerFactory.Instance, options);
        this.output = output;
    }
